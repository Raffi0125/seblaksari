...
<body class="bg-light">
    ...
    <div class="container-fluid position-fixed top-0 bg-dark p-2 d-flex justify-content-between" style="z-index: 2;">
        ...
        <div class="text-white h3 d-flex">
            ...
            <span class="mx-3">Warung Seblak Ala Sari</span>

        </div>
        
        <div class="d-flex align-items-center">
        <a class="btn btn-primary fw-bold mx-2" href="change_password.php">Change Password</a>
    ...
    <div id="dropdown-menu" class="container-fluid position-fixed float-start bg-dark text-white w-auto vh-100" style="display: none; z-index: 1; top: 50px;">
        ...
        <ul>
            ...
            <li><a class="text-decoration-none p-2 h5 text-light" href="dashboard.php">MENU</a></li><br>

            <?php if (isset($_SESSION["akun-admin"])) { ?>

            <li><a class="text-decoration-none p-2 h5 text-light" href="dashboard.php?pesanan">PESANAN</a></li><br>

            <li><a class="text-decoration-none p-2 h5 text-light" href="dashboard.php?transaksi">TRANSAKSI</a></li><br>

            <li><a class="text-decoration-none p-2 h5 text-light" href="dashboard.php?detail_transaksi">TRANSAKSI<br>/BULANAN</a></li>

            <?php } ?>

        </ul>
        <div class="mt-auto" style="margin-top: auto; padding: 20px;">
    ...
    else if (isset($_GET["detail_transaksi"])) include "halaman/detail_transaksi.php";
